...
export const INSTALL: Record<LanguageId, { command: string; shell: boolean; needs: string }> = {
  ...
  swift: {
    command: '.package(url: "https://github.com/Snaga-AI/uarp-swift", from: "0.3.0")',
    shell: false,
    needs: 'Swift 5.9+, macOS 12 / iOS 15',
  },
  kotlin: { command: 'implementation("ai.snaga:uarp-sdk:0.3.0")', shell: false, needs: 'Kotlin 2.2+, JVM 11+, Android 21+' },
