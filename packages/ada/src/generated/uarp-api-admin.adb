...
package body UARP.API.Admin is
   ...
   is
      Query : UARP.Types.Pair_Vectors.Vector;
   begin
      if Params.Has_Namespace then
         UARP.Types.Add (Query, "namespace", Params.Namespace);
      end if;
      if Params.Has_Include_Sensitive then
         UARP.Types.Add (Query, "include_sensitive", UARP.Models.Image (Params.Include_Sensitive));
      end if;
      return UARP.Client.Call_Raw
         (Self,
          "GET",
          "/api/v1/admin/data-explorer/export",
          Query => Query,
          Options => Options);
   end Export_Data_Explorer;
      ...
      begin
         ...
         declare
            Raw_Body : constant UARP.Types.Text := UARP.Client.Call_Raw
               (Self,
                "POST",
                "/api/v1/admin/data-explorer/import",
                Idempotent => True,
                Options => Options,
