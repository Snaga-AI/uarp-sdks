...
public class BillingApi internal constructor(private val client: UarpClient) {
     ...
     */
    public suspend fun clearBillingBudget(options: RequestOptions = RequestOptions()): ClearBillingBudgetResponse {
        return client.request<ClearBillingBudgetResponse>(
            RequestSpec(
                method = "DELETE",
     ...
     * Required scopes: `billing:read`.
     */
    public suspend fun getBillingBudget(options: RequestOptions = RequestOptions()): GetBillingBudgetResponse {
        return client.request<GetBillingBudgetResponse>(
            RequestSpec(
                method = "GET",
                path = "/api/v1/billing/budget",
                options = options,
     ...
     * Required scopes: `billing:read`.
     */
    public suspend fun getBillingOverage(options: RequestOptions = RequestOptions()): GetBillingOverageResponse {
        return client.request<GetBillingOverageResponse>(
            RequestSpec(
                method = "GET",
     ...
     * Required scopes: `billing:read`.
     */
    public suspend fun getPromoState(options: RequestOptions = RequestOptions()): GetPromoStateResponse {
        return client.request<GetPromoStateResponse>(
            RequestSpec(
                method = "GET",
     ...
     * Required scopes: `billing:read`.
     */
    public suspend fun redeemPromoCode(body: RedeemPromoCodeRequest, options: RequestOptions = RequestOptions()): RedeemPromoCodeResponse {
        return client.request<RedeemPromoCodeResponse>(
            RequestSpec(
                method = "POST",
     ...
     * Required scopes: `billing:write`.
     */
    public suspend fun setBillingBudget(body: SetBillingBudgetRequest, options: RequestOptions = RequestOptions()): SetBillingBudgetResponse {
        return client.request<SetBillingBudgetResponse>(
            RequestSpec(
                method = "PUT",
                path = "/api/v1/billing/budget",
                body = Body.Json(uarpJson.encodeToString(body)),
     ...
     * Required scopes: `billing:write`.
     */
    public suspend fun setBillingOverage(body: SetBillingOverageRequest, options: RequestOptions = RequestOptions()): SetBillingOverageResponse {
        return client.request<SetBillingOverageResponse>(
            RequestSpec(
                method = "PUT",
                path = "/api/v1/billing/overage",
                body = Body.Json(uarpJson.encodeToString(body)),
