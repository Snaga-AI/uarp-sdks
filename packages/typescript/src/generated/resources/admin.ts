 ...
 */
export interface ExportDataExplorerParams {
  /**
   ...
   */
  include_sensitive?: ExportDataExplorerIncludeSensitive;
}
...
export interface GetPlatformEconomicsParams {
   ...
   */
  refresh?: ExportDataExplorerIncludeSensitive;
}
...
export class AdminResource extends APIResource {
   ...
   * Required scopes: `admin`.
   */
  exportDataExplorer(params?: ExportDataExplorerParams, options?: RequestOptions): Promise<string> {
    return this._client.request({
      method: 'GET',
      path: '/api/v1/admin/data-explorer/export',
      query: pick(params, ['namespace', 'include_sensitive']),
      responseType: 'text',
      options,
    });
  }
   ...
   * Required scopes: `admin`.
   */
  importDataExplorer(body: ImportDataExplorerRequest, options?: RequestOptions): Promise<ImportDataExplorerResponse> {
    return this._client.request({
      method: 'POST',
